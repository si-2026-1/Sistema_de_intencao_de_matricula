...
| Mateus dos Santos de Queiroz | Módulo de Inteligência e Validação | Responsável pelo desenvolvimento do Módulo 3, incluindo filtros, validações e atualização em tempo real. |
| Yasmim de Sousa Chagas | Módulo de Captação de Interesse | Responsável pelo desenvolvimento do Módulo 2, incluindo funcionalidades de pré-matrícula. |
