...
| Yasmim de Sousa Chagas | Módulo de Captação de Interesse | Responsável pelo desenvolvimento do Módulo 2, incluindo funcionalidades de pré-matrícula, além da criação e edição dos slides da apresentação do projeto e suporte na implementação do MkDocs. |
